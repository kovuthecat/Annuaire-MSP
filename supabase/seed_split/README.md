# Seed découpé — ordre d'exécution dans le SQL Editor Supabase

Exécuter les fichiers **dans l'ordre du préfixe numérique** (00, 01, 02, ...).
...
- `seed_04_list_01.sql`  (1230 lignes, 98 Ko)
- `seed_99_controle.sql`  (0 lignes, 0 Ko)

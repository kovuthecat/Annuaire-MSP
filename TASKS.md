...
- [x] T-008 — Recueil de retours V1 : bouton flottant « Un souci ? » (popover au survol) + capture contexte/écran auto → table `feedback` + vue référent `/retours` · modèle: Opus, effort: high · plan: — (hors plan, cf. `DECISIONS.md` 2026-07-19 ; **rejouer `schema.sql` §6 avant usage**)

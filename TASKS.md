...
- [x] T-010 — Listes d'impression nommées et favorites (`/listes`) : tables + RLS, écrans, raccourci depuis l'impression · modèle: Sonnet, effort: medium · plan: — (hors plan, cf. `docs/decisions/2026-08-07-…` ; build/typecheck/test verts, migration prod + validation visuelle humaine restant à faire)
